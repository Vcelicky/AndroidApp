...
public class AdapterHiveWeightDetails extends ArrayAdapter<HiveBaseInfo> {

    ArrayList<HiveBaseInfo> hiveList;

    public AdapterHiveWeightDetails(Context context, ArrayList<HiveBaseInfo> hiveList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView = listInflater.inflate(R.layout.hive_row_weight, parent, false);
